...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { sender_id: @announcement.sender_id, text: @announcement.text, title: @announcement.title, type: @announcement.type } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { sender_id: @announcement.sender_id, text: @announcement.text, title: @announcement.title, type: @announcement.type } }
