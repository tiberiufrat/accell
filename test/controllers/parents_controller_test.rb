...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { family_id: @parent.family_id, quality: @parent.quality } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { family_id: @parent.family_id, quality: @parent.quality } }
